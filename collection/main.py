...
# args.model_save_file = args.model_save_path + args.model + "." + args.dataset + ".cifar10_lastlayer_beforebn_avgpool_eval"
# args.cm_file = args.model_save_path + args.model + "." + args.dataset + ".cifar10_lastlayer_beforebn_avgpool_eval" + suffix


# args.model_save_file = args.model_save_path + 'ViT-B_nonorm/' + args.dataset + ".layer_11D_mean_patch_12timm"
# args.cm_file = args.model_save_path + 'ViT-B_nonorm/' + args.dataset + ".layer_11D_mean_patch_12timm"

args.model_save_file = args.model_save_path + 'ViT-B_nonorm/' + args.dataset + ".layer_cfa_12timm"
args.cm_file = args.model_save_path + 'ViT-B_nonorm/' + args.dataset + ".layer_cfa_12timm"

# args.model_save_file = './save_model/ViT-B_16.imagenet.statistics'
# args.cm_file = 'ckpt/imagenet/cfa_model/ViT-B_16.imagenet.statistics'
# args.model_save_file = args.model_save_path + 'ViT-B/' + args.dataset + ".test"
# args.cm_file = args.model_save_path + 'ViT-B/' + args.dataset + ".test"
...
def main(args):
  ...
  if args.calc_statistics_flag:
      ...
      if os.path.exists(args.model_save_file) == False:
        ...
        # model = construct_model_cifar10(args)
        # model = construct_model_cifar100(args)
        print("Done.")
      ...
      # cifar10
      # source_train_loader, source_test_loader = load_cifar10(args)
      # cifar100
      # source_train_loader, source_test_loader = load_cifar100(args)
      print("**********************************")
      ...
      if os.path.exists(args.cm_file) == False:
          ...
          # CFA for each layer
          # calc_cmd_layer_statistics(args, model, source_train_loader)

          # Ours
          # calc_cmd_layer_statistics_11D_clsmean(args, model, source_train_loader)

          # for cifar 10
          # calc_cmd_layer_statistics_cifar10(args, model, source_train_loader)

          # for cifar100
          # calc_cmd_layer_statistics_cifar100(args, model, source_train_loader)
  ...
  if args.tta_flag:
      ...
      for j in range(len(CORRUPTION_SEVERITY)):
        ...
        # print(errorrate_list)
        print(f"error % [avg]: {sum(errorrate_list) / len(errorrate_list):.2}")
        print([round(err, 2) for err in errorrate_list])
#############################
